"# ASUS-ROG-L1.2-Threshould-validator" 

Utility script to scan the PCIe capabilities for the PCIe Root Device and GPU PCIe device to determine if the L1.2 Timing Thresholds are mismatched, as outlined in the following reddit thread:
